 ...
 *
 */
public class ElementActionDefBeanDefinitionParser extends
	...
	protected AbstractBeanDefinition parseInternal(@Nullable Element element,
        ...
        String elementFind = element
				.getAttribute(XsdElementConstants.ATTR_ELEMENTACTIONDEF_ELEMENTFIND);
        ...
        String elementAction = element
				.getAttribute(XsdElementConstants.ATTR_ELEMENTACTIONDEF_ELEMENTACTION);
