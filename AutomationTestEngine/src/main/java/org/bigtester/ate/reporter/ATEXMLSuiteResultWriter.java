...
public class ATEXMLSuiteResultWriter {

  private XMLReporterConfig config;

  public ATEXMLSuiteResultWriter(XMLReporterConfig config) {
    this.config = config;
  }
...
*/
  ...
  private Properties getSuiteResultAttributes(ISuiteResult suiteResult) {
    ...
    ATEXMLReporter.addDurationAttributes(config, attributes, tc.getStartDate(), tc.getEndDate());
    return attributes;
  }
